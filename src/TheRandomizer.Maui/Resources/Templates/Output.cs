...
namespace TheRandomizer.Maui.Resources.Templates
{
    ...
    #line 1 "C:\Users\me_la\source\repos\TheRandomizer\src\TheRandomizer.Maui\Resources\Templates\Output.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "18.0.0.0")]
    internal partial class Output : OutputBase
    {
#line hidden
        /// <summary>
    ...
    <body>
		");
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Content.Format switch 
			{
				...
				OutputFormats.Markdown => Utilities.MarkDigHelper.ToHtml(Content.Text),
				_ => $"<pre>{Content.Text}</pre>"
			}));
